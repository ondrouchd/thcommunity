    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-primary-600 to-primary-800">
      <div className="flex-1 flex flex-col items-center justify-center p-6">
        ...
        <div className="mb-8 text-center">
          ...
          />
          <h1 className="text-4xl font-bold text-white mb-2">THcommunity</h1>
          <p className="text-primary-200">Trénovaní ledního hokeje pro amatérské hráče.</p>
        </div>
        ...
        <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl p-6">
          ...
          <div className="space-y-3 mb-6">
            ...
            >
              ...
              <span className="text-gray-700">{t('auth.loginWithGoogle')}</span>
            </button>
          ...
          <form onSubmit={handleMagicLink} className="space-y-4">
            ...
            >
              {loading ? t('common.loading') : t('auth.loginWithMagicLink')}
            </button>
          </form>
